                    ...
                    <table width="100%" style="margin-top: 100px">
                        <tr>
                            ...
                            <td style="margin-top: 0; padding-top: 0px; padding-right: 120px; vertical-align: top;
                                width: 50%">
                                <asp:Label ID="labelSignUp" runat="server" Style="font-size: 1.9em; color: red; font-family: Chaucer;
                                    padding-left: 100px" Text="Thank you for your interest. </br> You will be among the very first to hear from us" />
                            </td>
